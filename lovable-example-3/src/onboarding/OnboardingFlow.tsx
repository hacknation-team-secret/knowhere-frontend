...
import { MapPin, Route as RouteIcon, Ticket, ArrowRight } from "lucide-react";
...
export function OnboardingFlow() {
  ...
  const enterApp = (path: "/app" | "/app/detour" | "/app/experiences") => {
  ...
  if (done) {
    return (
      <div className="min-h-screen grid place-items-center px-6 py-12">
        <div className="paper-card-lift p-8 md:p-10 max-w-[640px] w-full text-center">
          ...
          <div className="grid sm:grid-cols-3 gap-4 text-left">
            <LaunchTile
              ...
              title="City Pulse"
              description="Live map, nearby Detours, edit your context on the fly."
            ...
            <LaunchTile
              ...
              description="A 45–90 minute route shaped to your taste."
            ...
            <LaunchTile
              ...
              title="Experiences"
              description="Tours, classes, and food experiences via Viator."
              onClick={() => enterApp("/app/experiences")}
            />
          </div>
